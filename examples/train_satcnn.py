...
def createModelAndTrain():
    ...
    fullData = EuroSAT(root = "data/eurosat", include_additional_features = False, transform = sat_transform)
    ...
    print("\n************************")
    print("Test SatCNN model with EuroSAT dataset:")
