...
from geotorch.datasets.grid import TaxiBJ21
...
if __name__ == '__main__':
    ...
    test_dataset = TaxiBJ21(root = "data/partial_datasets/grid2", is_training_data = True)
    test_dataset.merge_closeness_period_trend(24, 1)
    print(len(test_dataset))
    sample = test_dataset[0]
    print(sample["x_data"].shape, sample["y_data"].shape)
    print("\n")

    test_dataset = TaxiBJ21(root = "data/partial_datasets/grid2", is_training_data = False)
    test_dataset.merge_closeness_period_trend(24, 1)
    print(len(test_dataset))
    sample = test_dataset[0]
    print(sample["x_data"].shape, sample["y_data"].shape)
