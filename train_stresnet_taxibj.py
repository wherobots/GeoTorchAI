...
def createModelAndTrain():
    ...
    print("\n************************")
    print("Test STResNet model with TaxiBJ21 dataset:")
    ...
    print("Mean RMSE: {0}, Mean Real RMSE: {1}, Variation of MAE: {2}".format(test_rmse_mean, rmse_mean, rmse_diff))
